...
- [DONE] select any text in the modal pops up a tool menu including: explain, highlight
...
- [DONE] when switch to another model, keep an eye on the previous model request. Use the earliest response
