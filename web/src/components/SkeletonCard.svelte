  ...
  <div class="flex flex-col gap-3">
    <div class="flex items-center justify-between">
      ...
      >
        ...
        <span class="text-[10px] font-bold text-primary tracking-widest font-fredoka"
          >ANALYZING</span
        >
      </div>
    </div>
    <div class="w-3/4 h-5 skeleton-shimmer rounded-lg opacity-60 dark:opacity-100"></div>
    <div class="w-1/2 h-5 skeleton-shimmer rounded-lg opacity-40 dark:opacity-100"></div>
  </div>
</article>
