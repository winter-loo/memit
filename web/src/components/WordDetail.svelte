<script>
  ...
  /** @typedef {{ word?: string, in_chinese?: string, simple_definition?: string, detailed_explanation?: string, ipa_pronunciation?: string, part_of_speech?: string, examples?: string[], error?: string, origins?: string, synonyms?: string[], antonyms?: string[] }} ExplainResult */
      ...
      <div class="flex gap-4">
        ...
        <div class="flex-grow pt-1">
          ...
          <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed italic">
            {details?.origins || `Etymology information for ${note.fields?.[0]} not available.`}
          </p>
        </div>
      </div>
    </div>
