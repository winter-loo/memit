...
>
  <div class="space-y-6">
    <!-- Daily Quest Card -->
    <div
      class="bg-white dark:bg-charcoal-blue rounded-3xl p-6 border border-slate-100 dark:border-white/5 shadow-lg relative group overflow-hidden"
    >
      <div class="flex justify-between items-center mb-4 relative z-10">
        <h3 class="font-bold font-display text-lg text-slate-800 dark:text-white">Daily Quest</h3>
        <span
          class="bg-primary/20 text-primary dark:text-primary-bright text-xs px-2 py-1 rounded-full font-bold relative z-10"
        >
          {dailyStudied}/{dailyGoal}
        </span>
      </div>
      <div
        class="relative w-full h-3 bg-slate-100 dark:bg-midnight-navy rounded-full overflow-hidden mb-4 z-10"
      >
        <div
      ...
      <p class="text-sm text-slate-500 dark:text-text-muted mb-4 relative z-10">
        {dailyStudied >= dailyGoal
          ? 'Goal achieved! Maintain your streak!'
          : `Review ${dailyGoal - dailyStudied} more words to maintain your streak!`}
      </p>
      <div
        class="flex items-center gap-3 p-3 bg-slate-50 dark:bg-midnight-navy/50 rounded-xl relative z-10"
      >
