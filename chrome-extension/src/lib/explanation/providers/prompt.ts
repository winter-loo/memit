...
export function buildExplainPrompt(text: string, targetLanguage = DEFAULT_LANGUAGE): string {
  return `
        ...
        {
            "term": "${text}",
            "ipaPronunciation": "International Phonetic Alphabet representation",
            "partOfSpeech": "noun/verb/adjective etc.",
            "simpleDefinition": "A clear, concise definition for a general audience.",
            "detailedExplanation": "A deeper look into the nuance and usage.",
            ...
            "contextUsage": "When to use this term (formal, casual, slang, archaic)."
        }
    `;
}
