...
const modalProps = $state<ModalProps>({
  ...
  onEditText: (original: string, replacement: string) => {
    ...
    const updated: DictionaryResponse = {
      ...
      simpleDefinition: replaceIn(modalProps.result.simpleDefinition),
      detailedExplanation: replaceIn(modalProps.result.detailedExplanation),
      translation: replaceIn(modalProps.result.translation),
      etymology: replaceIn(modalProps.result.etymology),
      contextUsage: replaceIn(modalProps.result.contextUsage),
